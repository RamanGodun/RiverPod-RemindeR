...
part of 'providers_cashed_for_10_or_25_sec.dart';
...
String _$getProductsListThatCashedFor10SecHash() =>
    r'641c08bac7a9d6bbbc9570f87ceceee423ff3bc2';
...
String _$getProductDetailsThatCashedFor25SecHash() =>
    r'2d1ff05035be7b35dd0f9316aedce5d90f937e74';
...
///
///
/// Copied from [getProductDetailsThatCashedFor25Sec].
...
class GetProductDetailsThatCashedFor25SecFamily
  ...
  ///
  /// Copied from [getProductDetailsThatCashedFor25Sec].
  GetProductDetailsThatCashedFor25SecProvider call({
    required int productId,
  }) {
    return GetProductDetailsThatCashedFor25SecProvider(
      productId: productId,
    );
  }
...
class GetProductDetailsThatCashedFor25SecProvider
  ...
  ///
  /// Copied from [getProductDetailsThatCashedFor25Sec].
  GetProductDetailsThatCashedFor25SecProvider({
    required int productId,
  }) : this._internal(
          ...
          allTransitiveDependencies: GetProductDetailsThatCashedFor25SecFamily
              ._allTransitiveDependencies,
          productId: productId,
        );
